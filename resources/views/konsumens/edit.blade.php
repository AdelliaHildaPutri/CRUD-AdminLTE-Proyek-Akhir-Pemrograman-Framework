...
@section('content')
    ...
    <div class="col-sm-12 text-center">
        <h1 class="m-3">Edit Data Konsumen</h1>
    </div>
        
  <div class="row mb-3">
    <label for="inputEmail3" class="col-sm-2 col-form-label text-right">Tanggal </label>
    <div class="col-sm-9">
    <input type="text" name="tanggal" value="{{ $konsumen->tanggal }}" class="form-control" placeholder="Tanggal">
    </div>
  </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-9">
    <input class="form-control" type="text" name="nama" value="{{ $konsumen->nama }}" placeholder="nama"></input>
    </div>
  </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-9">
    <input class="form-control" type="text" name="alamat" value="{{ $konsumen->alamat }}" placeholder="Alamat"></input>
    </div>
  </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-9">
    <input class="form-control" type="text" name="telp" value="{{ $konsumen->telp }}" placeholder="Telp"></input>
    </div>
  </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-9">
    <input class="form-control" type="text" name="kendaraan" value="{{ $konsumen->kendaraan }}" placeholder="Kendaraan"></input>
    </div>
  </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-9">
    <input class="form-control" type="text" name="harga" value="{{ $konsumen->harga }}" placeholder="harga"></input>
    </div>
  </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-9">
    <input class="form-control" type="text" name="metode_pembayaran" value="{{ $konsumen->metode_pembayaran }}" placeholder="Metode Pembayaran"></input>
    </div>
  </div>
