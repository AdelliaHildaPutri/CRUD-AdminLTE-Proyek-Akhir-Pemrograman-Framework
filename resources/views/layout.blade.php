...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <!-- <a href="index3.html" class="brand-link">
      <img src="{{ asset('template/dist/img/4.jpg')}}" alt="CRUD Proyek Akhir" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light"></span> 
    </a> -->

    <a href="index3.html" class="brand-link" style="width: auto; display: inline-block; white-space: nowrap;">
    <img src="{{ asset('template/dist/img/4.jpg')}}" alt="" class="brand-image img-circle elevation-3" style="opacity: .8">
    <span class="brand-text font-weight-light">CRUD Proyek Akhir</span> 
</a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="/konsumens" class="nav-link">
