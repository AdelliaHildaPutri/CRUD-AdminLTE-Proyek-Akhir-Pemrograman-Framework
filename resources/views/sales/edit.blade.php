...
@section('content')
    ...
    <div class="col-sm-12 text-center">
        <h1 class="m-3">Edit Data Sales</h1>
    </div>
     
    <div class="row mb-3">
    <label for="inputEmail3" class="col-sm-2 col-form-label text-right">Nama </label>
      <div class="col-sm-10">
    <input type="text" name="nama" value="{{ $sales->nama}}" class="form-control" placeholder="Nama">
    </div>
    </div>

  <div class="row mb-3">
    <label for="inputEmail3" class="col-sm-2 col-form-label text-right">Umur </label>
      <div class="col-sm-10">
    <input type="text" name="umur" value="{{ $sales->umur}}" class="form-control" placeholder="Umur">
    </div>
    </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-10">
      <input class="form-control" type="text" name="telp" value="{{ $sales->telp}}" placeholder="Telp"></input>
    </div>
    </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-10">
    <input class="form-control" type="text" name="alamat" value="{{ $sales->alamat}}" placeholder="Alamat"></input>
    </div>
    </div>
  ...
  <div class="row mb-3">
    <label for="inputEmail3" class="col-sm-2 col-form-label text-right">Email </label>
      <div class="col-sm-10">
    <input type="text" name="email" value="{{ $sales->email}}" class="form-control" placeholder="Email">
    </div>
    </div>
</div>
